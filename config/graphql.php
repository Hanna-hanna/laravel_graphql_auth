...
return [
    'schemas' => [
        'default' => [
            'query'    => [],
            'mutation' => [
                'createUser' => App\Domains\Users\GraphQL\Mutations\CreateUser::class,
                'login' => App\Domains\Users\GraphQL\Mutations\Login::class,
            ],
        ],
    ],
    'types' => [
        'User' => App\Domains\Users\GraphQL\Types\UserType::class,
    ],
    'route' => [
